...
Do **not** load this when you are about to attempt an operation rather than report on one.
This skill governs claims about what already happened, not plans for what will.
