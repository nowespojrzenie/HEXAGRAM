...
**Twelve skills in two families.** Ten carry a method that stands on its own; two carry an interpretive layer and say so from the first line.
...
- **Format:** conform to the [Agent Skills specification](https://github.com/agentskills/agentskills). All twelve carry the required frontmatter (name · description · license), measured 2026-09-04; the five original skills additionally validated against the reference `skills-ref` implementation.
- **Sizes:** 5.6–10.9 KB each (measured 2026-09-04). Small enough to read before trusting.
