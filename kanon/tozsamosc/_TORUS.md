...
package.json · kanon/tozsamosc/_TORUS.md · zapis_git.sh = INFRASTRUKTURA, nie treść kanonu.
Poza _HASHE.txt (jak kanon/ksiegi/ZAPISY_eter.md). Objęcie ich kontrolą integralności
