...
[![skills.sh](https://skills.sh/b/nowespojrzenie/HEXAGRAM)](https://skills.sh/nowespojrzenie/HEXAGRAM) `npx skills add nowespojrzenie/HEXAGRAM` — 11 skills, see [`skills/`](skills/)
...
> **Read [`START_TU.md` §8](START_TU.md) first** — HEXAGRAM needs an assistant with terminal and file access (Mode A, full). For models without a terminal there is Mode B (lite): paste any file from [`skills/`](skills/) and get the discipline without the engines. Eleven skills, installable with `npx skills add nowespojrzenie/HEXAGRAM` — see [`skills/README.md`](skills/README.md).
