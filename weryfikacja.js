...
if(process.argv.includes('--test')){
  ...
  if(rcPlus===0 && rcMinus===1 && rcForma===0 && rcTk===1 && rcFix===0){
    console.log('✓ STRAŻ ŻYWA: werdykt wstania wynika z kodu wyjścia, nie z tekstu.');
    process.exit(0);
  }
  console.log(`✗ STRAŻ MARTWA: rcPlus=${rcPlus} rcMinus=${rcMinus} rcForma=${rcForma} rcTk=${rcTk} rcFix=${rcFix} — rc nie odróżnia całego od zepsutego.`);
  process.exit(1);
}
