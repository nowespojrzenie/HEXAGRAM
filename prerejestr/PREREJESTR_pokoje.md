# PREREJESTR POKOI — runda 2 · v1.7.1

> [PRAWO] Prerejestr powstał przed audytem systemu i przed researchem §1.
>
> [PRAWO] Hipotez poniżej nie należy korygować wstecz na podstawie późniejszych ustaleń; §3 ma je rozliczyć osobno: potwierdzona / częściowo potwierdzona / obalona.
>
> [PRAWO] Hipoteza nie jest faktem i nie może zastępować adresu plik:linia w audycie.
...
| H6 | [REZONANS] Nadmierna granulacja obiektowa zwiększy narzut R0 i koszt operacyjny. | Pomiar pilota pokaże wzrost R0, liczby kontraktów lub kroków przekazania bez proporcjonalnego zysku w autonomii. | Granulacja nie zwiększy kosztu mierzalnego albo wzrost będzie pomijalny przy istotnym zysku w autonomii. |
| H7 | [REZONANS] Rola „prądowania” okaże się potrzebować własnego, jawnego kontraktu i granicy STOP, a nie tylko aliasu dla istniejącego etapu. | Po zdefiniowaniu O1 audyt i architektura wykażą własny stan, wejście/wyjście oraz odpowiedzialność/alarm. | O1 pokaże, że „prądowanie” jest tylko inną nazwą już istniejącej funkcji bez nowego stanu, zakresu lub odpowiedzialności. |
...
[NOŚNA RAMA] O3 · wieloinstancyjność ROLI: **OTWARTE**
