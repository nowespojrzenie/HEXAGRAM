...
node narzedzia/linty/lint_pryzmatu.js --audyt 2>&1 | tail -3 || echo "   (lint niedostępny)"
...
bash narzedzia/straze/straz_pochodzenia.sh 2>&1 | tail -2 || echo "   (straż niedostępna)"
